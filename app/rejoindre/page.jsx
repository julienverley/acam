...
const RejoindrePage = () => {
  return (
    <div className="mb-24 mx-auto w-full lg:w-3/5 xl:w-2/5 text-center px-3 md:px-0">
      ...
      <div className="mb-24 text-left mx-auto w-full lg:w-3/5 xl:w-2/5">
        ...
        <p>
          ...
          flûte irlandaise, saxophone, clarinette, cornemuse et trompette. Mais
          aussi des ateliers d’ensemble musicaux, une pratique musicale et de
          ...
          soirée théâtre, une soirée piano-cabaret, une soirée guitare-cabaret,
          les auditions des différents cours…
          <br />
          ...
          périscolaires pour que les enfants de l&apos;école puissent découvrir
          les arts et la culture.
          <br />
          Depuis l&apos;ouverture de la Mam (Maisons des assistantes maternelles
          de Montagny), l&apos;Acam propose également des ateliers de découverte
          artistique auprès des plus jeunes, qui peuvent ainsi explorer le monde
          des arts.
          <br />
          Notre association a également à coeur de proposer une offre culturelle
          et artistique de qualité dans une ambiance conviviale.
        </p>
        <br />
